...
export const alphaReleaseTagPrefix = config.alphaReleaseTagPrefix;
...
export function selectTag(tags: string[]): string | undefined {
  ...
  const _tagPrefix = preRelease === "alpha" ? alphaReleaseTagPrefix : tagPrefix;
  ...
  return selectedVersion ? _tagPrefix + selectedVersion : undefined;
}
